...
Сначала мы описуем сущность,  а дальше уже через метод выполняем SQL


////------- 12.6 Небольшой Хак -------
Заходим в Настройки/производительность/Таблицы   в  адресной строке дописываем параметр &orm=y
