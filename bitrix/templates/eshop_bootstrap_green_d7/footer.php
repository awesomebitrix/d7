...
Loc::loadMessages(__FILE__); //подключения языковых файлов через d7
?>
					</div>
					<?if (!$isCatalogPage):?>
		...
		<footer class="bx-footer">
			...
			<div class="bx-footer-bottomline">
				<div class="bx-footer-section container">
					...
					<div class="col-sm-6 bx-up"><a href="javascript:void(0)" data-role="eshopUpButton"><i class="fa fa-caret-up"></i> <?=Loc::getMessage("FOOTER_UP_BUTTON")?></a></div>
				</div>
			</div>
